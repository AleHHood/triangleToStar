...
/* harmony import */ var _modules_dragg__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/dragg */ "./src/js/modules/dragg.js");

window.addEventListener('DOMContentLoaded', function () {
  Object(_modules_dragg__WEBPACK_IMPORTED_MODULE_0__["default"])();
});

/***/ }),

/***/ "./src/js/modules/dragg.js":
/*!*********************************!*\
  !*** ./src/js/modules/dragg.js ***!
  \*********************************/
...
var dragg = function dragg() {
  var btn = document.querySelectorAll('.calculation__btn'),
  ...
  function GetDraggable(block, i) {
    // init Draggabillies
    var draggPush;
    draggPush = new draggabilly__WEBPACK_IMPORTED_MODULE_0___default.a(block, {// options...
    });
    console.log(i);
  ...
  function snap(activeBlock) {
    draggieBlocks.forEach(function (item, i) {
      ...
      var dy = activeBlock.position.y - snapBlock.position.y;
