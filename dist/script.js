...
/* harmony import */ var katex__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! katex */ "./node_modules/katex/dist/katex.js");
/* harmony import */ var katex__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(katex__WEBPACK_IMPORTED_MODULE_4__);
...
var getCalculation = function getCalculation(branchs) {
  ...
  function GetValueResist(R, K, numberBranch) {
    ...
    if (K < 2) {
      text = text + "\\newline \u041D\u0430\u0439\u0434\u0451\u043C~\u043F\u0440\u043E\u0432\u043E\u0434\u0438\u043C\u043E\u0441\u0442\u044C~\u0432\u0435\u0442\u0432\u0438~\u2116".concat(numberBranch, " \\newline g").concat(R[K].number, " = \\frac{1}{r").concat(R[K].number, "}");
      text = text + "\\newline g".concat(R[K].number, " = \\frac{1}{").concat(R[K].resistance, "} = ").concat(1 / +R[K].resistance, "~\u0421\u043C");
      ...
      text = text + "\\newline \u041D\u0430\u0439\u0434\u0451\u043C~\u043F\u0440\u043E\u0432\u043E\u0434\u0438\u043C\u043E\u0441\u0442\u044C~\u0432\u0435\u0442\u0432\u0438~\u2116".concat(numberBranch, " \\newline g").concat(Name, " = \\frac{1}{").concat(expression, "}");
      text = text + "\\newline g".concat(Name, " = \\frac{1}{").concat(expressionValue, "} = ").concat(value, "~\u0421\u043C");
      katex__WEBPACK_IMPORTED_MODULE_4___default.a.render(text, p, {
        throwOnError: false
      });
  ...
  function GetValueVoltage(R, K, numberBranch) {
    ...
    if (K === 0) {
      text = text + "\\newline \u042D\u0434\u0441~\u0434\u043B\u044F~\u0432\u0435\u0442\u0432\u0438~\u2116".concat(numberBranch, " \\newline 0~\u0412");
      katex__WEBPACK_IMPORTED_MODULE_4___default.a.render(text, p, {
        throwOnError: false
      });
    ...
    if (K < 2) {
      ...
      text = text + "\\newline \u042D\u0434\u0441~\u0434\u043B\u044F~\u0432\u0435\u0442\u0432\u0438~\u2116".concat(numberBranch, " \\newline E").concat(R[K].number, " = ").concat(voltage, "~\u0412");
      katex__WEBPACK_IMPORTED_MODULE_4___default.a.render(text, p, {
        throwOnError: false
      });
      ...
      text = text + "\\newline \u042D\u0434\u0441~\u0434\u043B\u044F~\u0432\u0435\u0442\u0432\u0438~\u2116".concat(numberBranch, " \\newline E").concat(Name, " = ").concat(expression);
      text = text + "\\newline E".concat(Name, " = ").concat(expressionValue, " = ").concat(value, "~\u0412");
      katex__WEBPACK_IMPORTED_MODULE_4___default.a.render(text, p, {
        throwOnError: false
      });
  ...
  function GetVoltageSсheme() {
    ...
    text = text + "\\newline \u041D\u0430\u043F\u0440\u044F\u0436\u0435\u043D\u0438\u0435~\u043C\u0435\u0436\u0434\u0443~\u0443\u0437\u043B\u0430\u043C\u0438~\u0410-\u0412~\u0440\u0430\u0432\u043D\u043E:\\newline Uab = \\frac{".concat(a, "}{").concat(b, "} = \\frac{").concat(expressionEG, "}{").concat(expressionG, "} = ").concat(toFixed2(U), "~\u0412");
    katex__WEBPACK_IMPORTED_MODULE_4___default.a.render(text, p, {
      throwOnError: false
    });
  }
  ...
  function FindCurrent() {
    ...
    parameters.forEach(function (element, i) {
      ...
      a = SliceElement(a, ' +');
      text = text + "\\newline \u041D\u0430\u0439\u0434\u0451\u043C~\u0442\u043E\u043A~\u0432~\u0432\u0435\u0442\u0432\u0438~\u2116:".concat(i, "\n        \\newline I").concat(i, " = ").concat(a, "*").concat(b, " = (").concat(expressionEU, ")*").concat(toFixed2(element.resistance), " = ").concat(I[i], "~\u0410");
      katex__WEBPACK_IMPORTED_MODULE_4___default.a.render(text, p, {
        throwOnError: false
      });
    });
...
var dragggrid = function dragggrid() {
  ...
  formSettings.addEventListener('click', function (event) {
    ...
    Object(_calculationMethod__WEBPACK_IMPORTED_MODULE_14__["default"])(Object(_getScheme__WEBPACK_IMPORTED_MODULE_13__["default"])(ActiveBlocks)
    /* SaveScheme() */
    );
  });
};
